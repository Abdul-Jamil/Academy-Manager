...
@Service
public class UpdatePaymentDescriptionUseCase {
    ...
    public UpdatePaymentDescriptionUseCase(PaymentRepository paymentRepository, BillRepository billRepository, UserRepository userRepository, StaffRepository staffRepository, RoleRepository roleRepository) {
    ...
    @Transactional
    public Payment execute(String userId, UUID paymentUUID, String descriptionStr) {
        ...
        if (descriptionStr == null || descriptionStr.isEmpty()) {
            payment.updateDescription(null);
        } else {
            Description description = new Description(descriptionStr);
            payment.updateDescription(description);
        }
