...
@Service
public class DeactivateDayOffUseCase {
    ...
    public DeactivateDayOffUseCase(UserRepository userRepository, DayOffRepository dayOffRepository, RoleRepository roleRepository, StaffRepository staffRepository) {
