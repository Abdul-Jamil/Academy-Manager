...
@Service
public class RemoveScheduleEntryUseCase {
    ...
    public RemoveScheduleEntryUseCase(
    ...
    @Transactional
    public void execute(String userId, UUID entryId) {

        ScheduleEntry entry = scheduleEntryRepository.findById(new ScheduleEntryId(entryId))
