...
@Service
public class UpdateClassDescriptionUseCase {
    ...
    public UpdateClassDescriptionUseCase(
    ...
    @Transactional
    public CourseClass execute(String userId, UUID classId, String descriptionStr) {
        ...
        courseClass.updateDescription(new Description(descriptionStr));
