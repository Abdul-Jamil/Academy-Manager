...
@Service
public class GetCurrentClassScheduleUseCase {
    ...
    public GetCurrentClassScheduleUseCase(
    ...
    public ClassSchedule execute(String userId, UUID classId) {
        ...
        return classScheduleRepository.findActiveByClassId(id)
                .orElseThrow(() -> new IllegalArgumentException("Class has no active schedule"));
    }
}
