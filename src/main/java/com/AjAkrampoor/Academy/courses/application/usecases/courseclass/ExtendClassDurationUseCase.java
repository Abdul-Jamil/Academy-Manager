...
@Service
public class ExtendClassDurationUseCase {
    ...
    public ExtendClassDurationUseCase(
    ...
    public CourseClass execute(
        ...
        if (!role.isSuperAdmin() &&
                !staff.getBranchId().equals(courseClass.getBranchId())) {
        ...
        DurationDays newDuration =
                courseClass.getDuration().addDays(addedDays);

        courseClass.updateDurationDays(newDuration);
