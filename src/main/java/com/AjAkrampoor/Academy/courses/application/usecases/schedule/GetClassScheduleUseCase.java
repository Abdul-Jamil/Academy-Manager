...
@Service
public class GetClassScheduleUseCase {
    ...
    public GetClassScheduleUseCase(
            ClassScheduleRepository classScheduleRepository, CourseClassRepository courseClassRepository, UserRepository userRepository, StaffRepository staffRepository, RoleRepository roleRepository
    ) {
    ...
    public ClassSchedule execute(String userId, UUID scheduleId) {
        ...
        ClassSchedule classSchedule = classScheduleRepository.findById(new ClassScheduleId(scheduleId))
                .orElseThrow(() -> new IllegalArgumentException("No such schedule found"));

        CourseClass courseClass = courseClassRepository.findById(classSchedule.getClassId())
