...
@Service
public class GetScheduleByWeekdayUseCase {
    ...
    public GetScheduleByWeekdayUseCase(
    ...
    public List<ScheduleEntry> execute(String userId, UUID scheduleId, DayOfWeek dayOfWeek) {
        ...
        return scheduleEntryRepository.findByScheduleIdAndDayOfWeek(id, dayOfWeek);
    }
}
